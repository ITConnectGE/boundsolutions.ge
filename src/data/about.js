...
export const vision = {
  ka: 'გავზარდოთ ჩვენი ორგანიზაცია თანამშრომლების ჩართულობისა და განვითარების გზით, სადაც ყველა ადამიანი პასუხისმგებელია შედეგზე და ხელს უწყობს ბრწყინვალე მომსახურებას.',
  en: 'Grow our organisation by enhancing employee engagement and development, where every person is accountable for results and helps deliver excellent service.',
}
...
export const values = [
  ...
  {
    key: 'ownership',
    title: { ka: 'მფლობელობა', en: 'Ownership' },
    text: {
      ka: 'ვიღებთ პასუხისმგებლობას პროცესზე, სტანდარტზე და შედეგზე. ბრალდებებისა და გამართლებების გარეშე.',
      en: 'Own the process, the standard, the outcome and the delivery. No finger-pointing, no excuses.',
    },
  },
  {
    key: 'curious',
    title: { ka: 'ცნობისმოყვარეობა', en: 'Curious' },
    text: {
      ka: 'ვისწრაფვით უცნობის დაძლევისკენ შეუპოვრობით, რომ ყოველდღე უკეთესები ვიყოთ ჩვენს საქმეში.',
      en: 'Yearn to overcome the unknown with perseverance that drives you to be better every day.',
    },
  },
  {
    key: 'courage',
    title: { ka: 'სიმამაცე', en: 'Courage' },
    text: {
      ka: 'გვაქვს გამბედაობა ვთქვათ ის, რაც სხვებს არ სურთ მოისმინონ, და გავცდეთ კომფორტის ზონას.',
      en: 'Share the concerns others may not want to hear, challenge the status quo and stretch beyond your comfort zone.',
    },
  },
]
...
export const team = [
  {
    name: { ka: 'ნინო ბართაია', en: 'Nino Bartaia' },
    role: { ka: 'Founder & CEO', en: 'Founder & CEO' },
    photo: founder.photo,
    placeholder: false,
  },
  {
    name: { ka: 'Katerina Kavtaradze', en: 'Katerina Kavtaradze' },
    role: { ka: 'Head of Human Resources', en: 'Head of Human Resources' },
    photo: '/images/team/katerina.jpg',
    placeholder: false,
  },
  {
    name: { ka: 'Elene Kochadze', en: 'Elene Kochadze' },
    role: { ka: 'HR Generalist', en: 'HR Generalist' },
    photo: '/images/team/elene.jpg',
    placeholder: false,
  },
  {
    name: { ka: 'Nata Mushkudiani', en: 'Nata Mushkudiani' },
    role: { ka: 'Freelance Recruiter', en: 'Freelance Recruiter' },
    photo: '/images/team/nata.jpg',
    placeholder: false,
  },
]
